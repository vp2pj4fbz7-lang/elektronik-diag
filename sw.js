const CACHE='elektronik-diag-v8-1-elements-pro';
const ASSETS=['./','./index.html','./pc_diagnostics_tools.js','./electronic_components_module.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./components.json','./device_categories.json','./elektronik_diag_db_v1.json'];
